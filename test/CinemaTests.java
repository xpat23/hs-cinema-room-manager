...
public class CinemaTests extends StageTest<String> {
    ...
    CheckResult test1_checkExit() {
        ...
        if (output == null || output.isEmpty()) {
            return CheckResult.wrong("The program terminated unexpectedly without any output. The program should prompt the user for input.");
        }
